...
import User from './src/assets/img/user-input.svg';
import Email from './src/assets/img/user-email.svg';
import Password from './src/assets/img/user-password.svg';
import PasswordShow from './src/assets/img/password-show.svg';
import PasswordHiden from './src/assets/img/password-hiden.svg';
import InputDelete from './src/assets/img/input-delete.svg';
import FacebookLogin from './src/assets/img/facebook-login.svg';
import Senha from './src/components/InputSenha'
  ...
  return (
    ...
    <View style={style.pergunta}>
      <Text style={style.pergunta1}>Já possui uma conta?</Text>
        <TouchableOpacity><Text style={style.pergunta2}> Faça o Login</Text></TouchableOpacity>
    </View>
    </SafeAreaView>
  );
};
